...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
  ...
  $bidang = isset($_POST['bidang']) ? mysqli_real_escape_string($mysqli, $_POST['bidang']) : '';

  if (empty($nama) || empty($bidang) || $bidang === '--pilih--') {
  ...
  $insert = mysqli_query($mysqli, "INSERT INTO tbl_antrian(tanggal, no_antrian, nama, bidang) 
                                   VALUES('$tanggal', '$no_antrian','$nama', '$bidang')")
