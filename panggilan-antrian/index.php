...
<body class="d-flex flex-column h-100">
        ...
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page"><a href="..\index.php" class="text-reset text-decoration-none">Dashboard</a></li>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      // $('#nama').load('get_sisa_antrian.php');
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        setTimeout(function() {
          responsiveVoice.speak("Nomor Antrian, " + data["no_antrian"] +",atas nama "+ data["nama"] + ", menuju ruangan"+data["bidang"], "Indonesian Male", {
            rate: 0.9,
            pitch: 1,
            volume: 1
          });
